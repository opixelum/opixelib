...
mod tests {
    ...
    fn test_flatten_forward() {
        ...
        input.set(&[0, 0, 0], 55).expect("Failed to set flatten input");
        input.set(&[0, 1, 0], 55).expect("Failed to set flatten input");
        input.set(&[1, 1, 1], 55).expect("Failed to set flatten input");
